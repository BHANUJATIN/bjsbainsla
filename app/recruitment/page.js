      ...
      <section className="grid-bg"
        ...
        <div className="container-xl" style={{ position:"relative", zIndex:1 }}>
          <div className="anim-fade-up delay-100" style={{ maxWidth: 700 }}>
            ...
            <p style={{ fontSize:"clamp(1rem, 2vw, 1.15rem)", color:"var(--text-secondary)", lineHeight:1.75, marginBottom:36 }}>
            ...
            <div style={{ display:"flex", flexWrap:"wrap", gap:14 }}>
              <motion.a
                ...
                style={{ display:"inline-flex", alignItems:"center", gap:8,
                  padding:"13px 26px", background:"#6EE7B7", color:"var(--bg-page)",
              ...
              <motion.a
                ...
                style={{ display:"inline-flex", alignItems:"center", gap:8,
                  padding:"13px 26px", border:"1px solid var(--border)", color:"var(--text-primary)",
      ...
      <section style={{ padding:"96px 0", position:"relative", overflow:"hidden" }}>
        ...
        <div className="container-xl" style={{ textAlign:"center", position:"relative", zIndex:1 }}>
          ...
          >
            ...
            <p style={{ fontSize:16, color:"var(--text-secondary)", maxWidth:440, margin:"0 auto 40px", lineHeight:1.7 }}>
